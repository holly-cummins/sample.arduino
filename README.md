...
The Liberty Arduino library is named Liberty.zip, download that to your local file system from the [github release page](http://github.com/WASdev/sample.arduino.wlp/releases/download/v.0.0.17/Liberty.zip), and install it in the Arduino IDE - on the menu bar choose "Sketch -> Import Library -> Add Library..." and select library zip you just downloaded. 
...
Download the sample-server jar file from the [github release page](https://github.com/WASdev/sample.arduino.wlp/releases/download/v.0.0.17/sample-server-0.0.17.jar), and at a command prompt in your Liberty wlp directory use the java command to install the sample server:

```java -jar sample-server-0.0.17.jar```
